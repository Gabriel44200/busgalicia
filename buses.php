...
// Obtener los datos de la tabla `buses`
$sql = "SELECT * FROM buses LIMIT $primer_resultado, $resultados_por_pagina";
$result = $conn->query($sql);

// Contar el número total de resultados en la tabla `buses`
$sql_total = "SELECT COUNT(*) AS total FROM buses";
    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td><?php echo $row['fecha_matriculacion']; ?></td>
            </tr>
        <?php endwhile; ?>
    <?php else: ?>
        <tr>
...
<div class="pagination">
    <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
        <a href="buses.php?pagina=<?php echo $i; ?>" class="<?php echo $i == $pagina ? 'active' : ''; ?>"><?php echo $i; ?></a>
    <?php endfor; ?>
</div>
